...
const DashboardOfCustomer = () => {
  return (
    <div className="w-full relative bg-white overflow-hidden flex flex-col items-start justify-start pt-[2rem] px-[0rem] pb-[0rem] box-border gap-[4.987rem] leading-[normal] tracking-[normal] mq450:gap-[1.25rem] mq750:gap-[2.5rem]">
      ...
      <section className="self-stretch flex flex-col items-start justify-start gap-[2.562rem] max-w-full mq750:gap-[1.25rem]">
        <header className="self-stretch flex flex-row items-start justify-center pt-[0rem] px-[1.25rem] pb-[1.437rem] box-border max-w-full text-left text-[1.638rem] text-gray-2200 font-inter">
          <div className="w-[72.5rem] flex flex-row items-start justify-between gap-[1.25rem] max-w-full">
            <div className="w-[7.188rem] flex flex-col items-start justify-start pt-[0.062rem] pb-[0rem] pr-[1.25rem] pl-[0rem] box-border">
              <a className="[text-decoration:none] relative font-semibold text-[inherit] inline-block min-w-[5.188rem] whitespace-nowrap">
                Drivee
              </a>
            </div>
            <div className="w-[19.188rem] flex flex-col items-start justify-start pt-[0.406rem] px-[0rem] pb-[0rem] box-border text-[1.063rem]">
              <div className="self-stretch flex flex-row items-center justify-start mq450:gap-[1rem]">
...
export default DashboardOfCustomer;
