...
const NameInput = ({
  ...
  return (
    <div className={`self-stretch flex flex-col items-start justify-start gap-[0.393rem] text-left text-[0.919rem] text-gray-1600 font-inter ${className}`}>
      ...
      <div className="self-stretch shadow-[0px_3.1px_6.3px_rgba(18,_18,_18,_0.03)] rounded-6xs-3 bg-white flex flex-row items-center justify-start py-[0.687rem] px-[1rem] border-[1px] border-solid border-lightslategray-200">
        <input
          ...
          value={value}
          onChange={onChange}
          className="w-full [border:none] [outline:none] bg-[transparent] h-[1.188rem] flex flex-row items-center justify-start font-inter text-[0.788rem] text-lightslategray-100"
